...
_ParkingInfo _$ParkingInfoFromJson(Map<String, dynamic> json) => _ParkingInfo(
  ...
  parkingNm: json['PARKING_NM'] == null ? '' : _toString(json['PARKING_NM']),
  ...
  jibunAddr: json['JIBUN_ADDR'] == null ? '' : _toString(json['JIBUN_ADDR']),
  roadAddr: json['ROAD_ADDR'] == null ? '' : _toString(json['ROAD_ADDR']),
  parkingCnt: json['PARKING_CNT'] == null ? -1 : _toInt(json['PARKING_CNT']),
  operGb: json['OPER_GB'] == null ? '' : _toString(json['OPER_GB']),
  parkingFee: json['PARKING_FEE'] == null ? '' : _toString(json['PARKING_FEE']),
  mngAgencyNm:
      json['MNG_AGENCY_NM'] == null ? '' : _toString(json['MNG_AGENCY_NM']),
  areaGb: json['AREA_GB'] == null ? '' : _toString(json['AREA_GB']),
  areaGbSub: json['AREA_GB_SUB'] == null ? '' : _toString(json['AREA_GB_SUB']),
  ...
  lastUpdateDt:
      json['LAST_UPDATE_DT'] == null ? '' : _toString(json['LAST_UPDATE_DT']),
);
